...
$tiktok_access_token = "f33269a4bbca20c4ecaf58af575cc4ad94bb6ec7"; // Sostituiscilo con il token generato
...
$data = [
    "event_source" => "web",
    "event_source_id" => "CUQ76GBC77U38KO2E490", // Sostituiscilo con il tuo event_source_id
    "data" => [
        [
            "event" => "SubmitForm",
            "event_time" => time(),
...
header('Location: https://landing.car-vizio.it/thankyou-ac1.html');
exit();
