...
$tiktok_access_token = "df2fbadfedfcd66e20683eb16091228aeb195c94"; // Sostituiscilo con il token generato
...
$data = [
    "event_source" => "web",
    "test_event_code" => "TEST23705",
    "event_source_id" => "CUQ601BC77U0037LU370", // Sostituiscilo con il tuo event_source_id
    "data" => [
        [
            "event" => "SubmitForm",
            "event_time" => time(),
